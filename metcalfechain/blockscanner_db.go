...
func (bs *MBlockScanner) SaveLocalBlockHead(blockHeight uint32, blockHash string) error {
...
func (bs *MBlockScanner) GetLocalBlockHead() (uint32, string, error) {
...
func (bs *MBlockScanner) SaveLocalBlock(blockHeader *Block) error {
...
func (bs *MBlockScanner) GetLocalBlock(height uint32) (*Block, error) {
...
func (bs *MBlockScanner) SaveUnscanRecord(record *openwallet.UnscanRecord) error {
...
func (bs *MBlockScanner) DeleteUnscanRecord(height uint32) error {
...
func (bs *MBlockScanner) GetUnscanRecords() ([]*openwallet.UnscanRecord, error) {
