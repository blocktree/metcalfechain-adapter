...
//MBlockScanner ontology的区块链扫描器
type MBlockScanner struct {
...
//NewMBlockScanner 创建区块链扫描器
func NewMBlockScanner(wm *WalletManager) *MBlockScanner {
	bs := MBlockScanner{
...
func (bs *MBlockScanner) SetRescanBlockHeight(height uint64) error {
	height = height - 1
	if height < 0 {
...
//ScanBlockTask 扫描任务
func (bs *MBlockScanner) ScanBlockTask() {
...
//ScanBlock 扫描指定高度区块
func (bs *MBlockScanner) ScanBlock(height uint64) error {
...
func (bs *MBlockScanner) scanBlock(height uint64) (*Block, error) {
	var (
		block *Block
		err   error
	)
...
func (bs *MBlockScanner) ScanTxMemPool() {
...
func (bs *MBlockScanner) RescanFailedRecord() {
...
func (bs *MBlockScanner) BatchExtractTransaction(blockHeight uint64, blockHash string, txs []string, memPool bool) error {
...
func (bs *MBlockScanner) extractRuntime(producer chan ExtractResult, worker chan ExtractResult, quit chan struct{}) {
...
func (bs *MBlockScanner) ExtractTransaction(blockHeight uint64, blockHash string, txid string, scanAddressFunc openwallet.BlockScanTargetFunc, memPool bool) ExtractResult {
...
func (bs *MBlockScanner) extractTransaction(trx *Transaction, result *ExtractResult, scanAddressFunc openwallet.BlockScanTargetFuncV2) {
	var (
		success = true
	)
...
func (bs *MBlockScanner) newExtractDataNotify(height uint64, extractData map[string]*openwallet.TxExtractData) error {
...
func (bs *MBlockScanner) DeleteUnscanRecordNotFindTX() error {
...
//func (bs *MBlockScanner) SaveRechargeToWalletDB(height uint64, list []*openwallet.Recharge) error {
//
//	for _, r := range list {
//
...
func (bs *MBlockScanner) GetCurrentBlockHeader() (*openwallet.BlockHeader, error) {
	var (
...
func (bs *MBlockScanner) GetScannedBlockHeader() (*openwallet.BlockHeader, error) {
...
func (bs *MBlockScanner) GetScannedBlockHeight() uint64 {
	localHeight, _, _ := bs.wm.Blockscanner.GetLocalNewBlock()
	return localHeight
}

func (bs *MBlockScanner) ExtractTransactionData(txid string, scanTargetFunc openwallet.BlockScanTargetFunc) (map[string][]*openwallet.TxExtractData, error) {
...
//func (bs *MBlockScanner) DropRechargeRecords(accountID string) error {
//	bs.mu.RLock()
//	defer bs.mu.RUnlock()
//
...
//func (bs *MBlockScanner) DeleteRechargesByHeight(height uint64) error {
//
//	bs.mu.RLock()
//	defer bs.mu.RUnlock()
//
...
func (bs *MBlockScanner) GetSourceKeyByAddress(address string) (string, bool) {
	bs.Mu.RLock()
	defer bs.Mu.RUnlock()
...
// func (bs *MBlockScanner) GetWalletByAddress(address string) (*openwallet.Wallet, bool) {
// 	bs.mu.RLock()
// 	defer bs.mu.RUnlock()
...
func (bs *MBlockScanner) GetLocalNewBlock() (uint64, string, error) {
...
func (bs *MBlockScanner) SaveLocalNewBlock(blockHeight uint64, blockHash string) error {
...
func (bs *MBlockScanner) GetBalanceByAddress(address ...string) ([]*openwallet.Balance, error) {
...
func (bs *MBlockScanner) GetTransactionsByAddress(offset, limit int, coin openwallet.Coin, address ...string) ([]*openwallet.TxExtractData, error) {
	//
	//var (
...
//Run 运行
func (bs *MBlockScanner) Run() error {
...
////Stop 停止扫描
func (bs *MBlockScanner) Stop() error {
...
//Pause 暂停扫描
func (bs *MBlockScanner) Pause() error {
...
//Restart 继续扫描
func (bs *MBlockScanner) Restart() error {
...
func (bs *MBlockScanner) setupSocketIO() error {
...
//@optional
func (bs *MBlockScanner) SupportBlockchainDAI() bool {
	return true
}
