...
func TestWalletManager_CreateWallet(t *testing.T) {
	...
	w := &openwallet.Wallet{Alias: "HELLO M", IsTrust: true, Password: "12345678"}
...
func TestWalletManager_GetWalletInfo(t *testing.T) {
	...
	wallet, err := tm.GetWalletInfo(testApp, "W9WWiFFD85sBYpUsfPjC6CJwPGi7wVTf4v")
	if err != nil {
...
func TestWalletManager_CreateAssetsAccount(t *testing.T) {
	...
	walletID := "W9WWiFFD85sBYpUsfPjC6CJwPGi7wVTf4v"
	account := &openwallet.AssetsAccount{Alias: "M", WalletID: walletID, Required: 1, Symbol: "M", IsTrust: true}
...
func TestWalletManager_CreateAddress(t *testing.T) {
	...
	walletID := "W9WWiFFD85sBYpUsfPjC6CJwPGi7wVTf4v"
	accountID := "7LJsQhuoQXj9GUE13WZLiwp41tRw3YnddsT2v4iBRMmy"
