package metcalfechainTransaction
...
var (
	RippleAlphabet = NewAlphabet("Mpshnaf39wBUDNEGHJKLr4PQRST7VWXYZ2bcdeCg65jkm8oFqi1tuvAxyz")
)
...
func GetProgramHashFromAddress(address string) ([]byte, error) {
	if strings.Index(address, "MTC") != 0 {
		return nil, errors.New("invalid address")
	}

	addr := "M" + address[3:]
	ret, err := Decode(addr, RippleAlphabet)
	if err != nil {
		return nil, errors.New("Invalid address!")
	}
